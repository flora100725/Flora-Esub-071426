Super, please improve previous design by keeping all original features and adding additional features that 1. Please adding additional module that  User can paste submission doc list (txt, md, pdf), then agent (default gemini-3.1-flash-lite, user can select other models and modify prompt) will regouping the doc in a table in markdown in traditional chinese with title, category, file name, comments. User can modify the results in markdown or download (md, json). Then user can paste or upload review checklist or use default review checklist (md, json, pdf).  Then agent (default gemini-3.1-flash-lite, user can select other models and modify prompt) will using the previous modify doc list and using the review checklist to create a review screening report in markdown in Traditional CHinese in 3000 to 4000 words. User can modify the results in markdown/html or download (md, html). 

Please adding a new feature that user can paste or upload IFU (md, txt, pdf). Please let user to select pages to do OCR (user can select 5 python based ocr or llm based ocr, default gemini-3.1-flash-lite). Agent will create a comprehensive summary of the IFU in markdown in Traditional Chinese in 3000 to 4000 words with 5 tables for majoy device spec, accessaries, software features. Use can modify resuls in markdown or download. Then user can keep prompt (default gemini-3.1-flash-lite, user can select models) on the IFU or use ai magics on the IFU (6 wow ai features created by you).  
Enable users to select their preferred default LLM model, specifying 'gemini-3.1-flash-lite' as the default but allowing selection of other models. 

Integrate dynamic and visually appealing effects for LLM execution, including interactive indicators and live logs. Design a dashboard featuring six distinct graphs to present real-time data and processing status. Ensure the visualizations are intuitive and provide clear feedback to the user about the AI's operations. Please also adding 3 additional wow ai features to this app. Please fix blank screen bugs and iterate until get excellent results. Ending with 20 comprehensive follow up questions.4、行政文件
Sample submission doc list: 
	1_送審表\1_須檢附至食藥署文件_第二_三等級醫療器材
		1150615查驗登記＿第2、3等級申請醫療器材查驗登記送審表_0608用印-.pdf

	3_十、類似品\9_醫療器材查驗登記申請書_佐證資料
		115060307-3_[許可證] 衛部醫器製字第006630號 (All) 慶旺25.pdf   備註說明：產品許可證衛部醫器製字第006630號

	3_十、類似品\8_醫療器材查驗登記申請書_醫療器材產品同等
		115060307-1_類似品同質性比較表_20260603送件.pdf   備註說明：針對類似品LX系列產品之同等比較表

	3_十、類似品\7_經本部核准類似品或相關產品資料_類似品經
		115060307-2_[中文仿單] 衛部醫器製字第006630號 (All) 慶旺25.pdf   備註說明：衛部醫器製字第006630號核定之產品標籤及中文仿單

	5_二三等級查登申請書
		1150615查驗登記＿第2、3等級醫療器材查驗登記申請書_0608用印.pdf

	8_四、醫材商許可執照\267_查驗登記_受託製造業者醫療器材商許可執照
		115060304-2_奔騰_製造業醫療器材商許可執照.pdf   備註說明：醫療器材製造業許可執照_委託製造廠-奔騰

	8_四、醫材商許可執照\15_醫療器材商許可執照影本_醫療器材商販賣業
		1150603超象_販賣業藥商許可證.pdf

	8_四、醫材商許可執照\16_醫療器材商許可執照影本_醫療器材商製造業
		115060304-2_[執照] 超象科技製造業醫療器材商 2506.pdf

	11_七、品質管理系統\18_醫療器材製造業者符合醫療器材品質管理系統
		115060305-1_[超象]QMS2191 認可登錄函_P1550-2310-2610.pdf   備註說明：超象_QMS2191

	12_九、委託製造\19_委託製造契約相關文件_涉及於許可證刊載委
		115060305-2_奔騰_TFDA QMS2179醫療器材品質管理系統準則核備函_效期20290724.pdf   備註說明：委託製造廠-奔騰智慧_QMS2179

	13_十一、標籤、說明書擬稿\24_標籤、說明書或包裝擬稿_原廠標籤、包裝
		1150603空白.pdf   備註說明：請參考中文標籤檔案

	13_十一、標籤、說明書擬稿\23_標籤、說明書或包裝擬稿_產品中文標籤、包
		115060308-1_[標籤外觀] 衛部醫器製字第00XXXX號_LX.docx   備註說明：中文標籤草稿

	13_十一、標籤、說明書擬稿\27_標籤、說明書或包裝擬稿_中文型錄、說明書
		115060308-3_[產品照片] 衛部醫器製字第00XXX號(LX)_20260603送件.pdf   備註說明：產品圖片

	13_十一、標籤、說明書擬稿\27_標籤、說明書或包裝擬稿_中文型錄、說明書
		115060308-2_[中文仿單] 衛部醫器製字第00XXX號(LX)_20260603送件.pdf   備註說明：中文仿單

	13_十一、標籤、說明書擬稿\25_標籤、說明書或包裝擬稿_原廠型錄及產品使
		115060309-7_LK_UI-LX-01TW-LX-UM_2604.pdf   備註說明：LX系列-使用手冊

	13_十一、標籤、說明書擬稿\25_標籤、說明書或包裝擬稿_原廠型錄及產品使
		115060308-3_LeltekBrochure_LX_series_251111.pdf   備註說明：LX系列-產品型錄
5、技術性資料

	14_十二、結構_材料_規格等\30_產品之結構、各部分組成名稱
		115060309-3_LK_QR-RD-LX-014-B 機構設計圖面(LX)_20260603送件.pdf   備註說明：產品爆炸圖

	14_十二、結構_材料_規格等\31_各部分組成及材料之對照表
		1150603空白.pdf   備註說明：同產品爆炸圖

	14_十二、結構_材料_規格等\36_原廠維修手冊
		1150603空白.pdf   備註說明：同LX Series User Manual

	14_十二、結構_材料_規格等\37_提供美國FDA對本案產品之Regulat
		115060309-9_510(k)_K243226.pdf   備註說明：FDA website screenshot_510(K)_K243226

	14_十二、結構_材料_規格等\35_原廠操作手冊
		115060309-7_LK_UI-LX-01TW-LX-UM_2604.pdf   備註說明：LX Series User Manual

	20_人因工程
		115060810_LX IEC 62366-1 Usability test LK_QR-RD-LX-007Att1_2510(15).pdf   備註說明：Usability test report

	22_十五、EP_STED\269_製程流程圖
		1150603LX產品製造流程_2606.pdf   備註說明：LX系列產品製造流程圖

	22_十五、EP_STED\47_風險分析與控制報告
		1150603LK_QR-RMF-004Risk assessment, risk control measuresF 24(LK_QR-RMF-LU700-004)_A4.pdf   備註說明：LK_QR-RMF-004 Risk assessment, risk control measures_F

	22_十五、EP_STED\47_風險分析與控制報告
		1150603LK_QR-RMF-006Risk Management ReportE 23(LK_QR-RMF-LU700-005)_A4.pdf   備註說明：LK_QR-RMF-006 Risk Management Report_E

	22_十五、EP_STED\47_風險分析與控制報告
		1150603LK_QR-RMF-001Risk Management PlanF 24(LK_QR-RMF-LU700-001)_A4.pdf   備註說明：LK_QR-RMF-001 Risk Management Plan_F

	22_十五、EP_STED\47_風險分析與控制報告
		1150603LK_QR-RMF-002The list of the safety characteristically questionsF 24(LK_QR-RMF-LU700-002)_A4.pdf   備註說明：LK_QR-RMF-002 The list of the safety characteristically questions_F

	22_十五、EP_STED\47_風險分析與控制報告
		115060361b21_LX IEC 62366-1 Usability test LK_QR-RD-LX-007Att1_2510(15).pdf   備註說明：IEC 62366-1 Usability test

	22_十五、EP_STED\47_風險分析與控制報告
		1150603LK_QR-RMF-003Preliminary hazard analysisF 24(LK_QR-RMF-LU700-003)_A4.pdf   備註說明：LK_QR-RMF-003 Preliminary hazard analysis_F

	22_十五、EP_STED\45_STED技術文件
		1150608IEC 62133-2 Yu Xin (50262545001)_SZYX1036B7_.pdf   備註說明： IEC 62133-2 Yu Xin (50262545001) - 電池安全測試

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RMF-003Preliminary hazard analysisF 24(LK_QR-RMF-LU700-003)_A4.pdf   備註說明：LK_QR-RMF-003Preliminary hazard analysis

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RD-LX-301 (IEC62359_YY0642) Acoustic Output Report(250414)_Jedit.pdf   備註說明：LK_QR-RD-LX-301 (IEC62359) Acoustic Output Report

	22_十五、EP_STED\45_STED技術文件
		115060806_[MASVS] Security test(00004879-24MST001-FR101V10)Android.pdf   備註說明：[MASVS] Security test(00004879-24MST001-FR101V10) for Android

	22_十五、EP_STED\45_STED技術文件
		1150608241_LK_QR-RD-LU700-105_Software Verification and Validation_D.docx.pdf   備註說明：LK_QR-RD-LU700-105_Software Verification and Validation

	22_十五、EP_STED\45_STED技術文件
		1150608233_LK_QR-RD-LU700-102_Software Requirements Specification(SRS)_D.docx.pdf   備註說明：LK_QR-RD-LU700-102_Software Requirements Specification(SRS)

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RD-LU700-030_att1_Medical Device Cybersecurity–MDS2_資訊安全A22.xlsx.pdf   備註說明：LK_QR-RD-LU700-030_att1_Medical Device Cybersecurity–MDS2_資訊安全

	22_十五、EP_STED\45_STED技術文件
		115060806.1b01_128 ISO 10993-23 Intracutaneous Reactivity 2023-3313-002(E)24.pdf   備註說明：ISO 10993-23 Intracutaneous Reactivity

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RMF-001Risk Management PlanF 24(LK_QR-RMF-LU700-001)_A4.pdf   備註說明：LK_QR-RMF-001Risk Management Plan

	22_十五、EP_STED\45_STED技術文件
		1150608230_LK_QR-RD-LU700-100_Software Safety Classification_Ver_02.docx.pdf   備註說明：LK_QR-RD-LU700-100_Software Safety Classification

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QI-QM-X01QCflowchart(LX)A.xlsx.pdf   備註說明：LK_QI-QM-X01QCflowchart(LX

	22_十五、EP_STED\45_STED技術文件
		115060811-3_LX IEC 60601-1-2 (EUEC249094002)2502.pdf   備註說明：LX IEC 60601-1-2 (EUEC249094002)

	22_十五、EP_STED\45_STED技術文件
		1150608240_LK_QR-RD-LU700-101_Software Design and Development Plan_D 2402.docx.pdf   備註說明：LK_QR-RD-LU700-101_Software Design and Development Plan

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QI-IQC-001-Ver_08 IQC檢驗規範_controlled.pdf   備註說明：LK_QI-IQC-001-Ver_08 IQC檢驗規範

	22_十五、EP_STED\45_STED技術文件
		115060806.1b01_LK_QR-EVA-LX-002 _ISO10993-18 Evaluation report_Ver_01_2501.pdf   備註說明：LK_QR-EVA-LX-002 _ISO10993-18 Evaluation report

	22_十五、EP_STED\45_STED技術文件
		115060806_[MASVS] Security test(00004879-24MST001-FR101V10)Windows.pdf   備註說明：06_[MASVS] Security test(00004879-24MST001-FR101V10) for Windows

	22_十五、EP_STED\45_STED技術文件
		115060811-2_LX IEC 60601-1(TSSM2410000449L0)f_2503.pdf   備註說明：LX IEC 60601-1 (TSSM2410000449L0)

	22_十五、EP_STED\45_STED技術文件
		115060811-3_LX IEC 60601-1-2 (EUEC249094002)Photo2502.pdf   備註說明：LX IEC 60601-1-2 (EUEC249094002) Photo

	22_十五、EP_STED\45_STED技術文件
		1150608231_LK_QR-RD-LU700-103_Software General Design(7,8,LX)_D24.pdf   備註說明：LK_QR-RD-LU700-103_Software General Design

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RD-LU700-030 Medical device Cybersecurity Management Plan and Report_A4.pdf   備註說明：LK_QR-RD-LU700-030 Medical device Cybersecurity Management Plan and Report

	22_十五、EP_STED\45_STED技術文件
		1150608LX IEC60529(IP68)YX10010_LX128LP.pdf   備註說明：LX IEC60529 (IP68) YX10010_LX128LP

	22_十五、EP_STED\45_STED技術文件
		1150608241_LK_QR-RD-LU700-112_Software System Test Plan_D.docx.pdf   備註說明：241_LK_QR-RD-LU700-112_Software System Test Plan

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RMF-002The list of the safety characteristically questionsF 24(LK_QR-RMF-LU700-002)_A4.pdf   備註說明：LK_QR-RMF-002The list of the safety characteristically questions

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QI-OQC-001OQC檢驗規範(All)Ver_0425.docx.pdf   備註說明：LK_QI-OQC-001 OQC檢驗規範

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RMF-004Risk assessment, risk control measuresF 24(LK_QR-RMF-LU700-004)_A4.pdf   備註說明：LK_QR-RMF-004Risk assessment, risk control measures

	22_十五、EP_STED\45_STED技術文件
		115060811-7_LX IEC 60601-1-6 (TSSM2410000450L1)f_2503.pdf   備註說明：LX IEC 60601-1-6 (TSSM2410000450L1)

	22_十五、EP_STED\45_STED技術文件
		115060806.1b01_128 ISO 10993-5 In Vitro Cytotoxicity MTT_2023-3313-001（E）24.pdf   備註說明：ISO 10993-5 In Vitro Cytotoxicity

	22_十五、EP_STED\45_STED技術文件
		115060806.1b01_128 ISO 10993-10 Skin Sensitization 2023-3313-004 （E）24.pdf   備註說明：ISO 10993-10 Skin Sensitization

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QI-FQC-X01-Ver_02 LX系列FQC檢驗規範_controlled.pdf   備註說明：LK_QI-FQC-X01-Ver_02 LX系列FQC檢驗規範

	22_十五、EP_STED\45_STED技術文件
		115060809-7_LK_UI-LX-01TW-LX-UM_2604.pdf   備註說明：LX series User Manual

	22_十五、EP_STED\45_STED技術文件
		115060810_LX IEC 62366-1 Usability test LK_QR-RD-LX-007Att1_2510(15).pdf   備註說明：IEC 62366-1 Usability test LK_QR-RD-LX-007

	22_十五、EP_STED\45_STED技術文件
		1150608242_LK_QR-RD-LU700-120_Software Configuration Status Report_Q.xls.pdf   備註說明：LK_QR-RD-LU700-120_Software Configuration Status Report

	22_十五、EP_STED\45_STED技術文件
		1150608234_LK_QR-RD-LU700-103_Appendix 1 SAD Chart_D23.docx.pdf   備註說明：LK_QR-RD-LU700-103_Appendix 1 SAD Chart

	22_十五、EP_STED\45_STED技術文件
		115060806.1b01_128 ISO 10993-23 Vaginal Irritation 2023-3313-003(E)24.pdf   備註說明： ISO 10993-23 Vaginal Irritation

	22_十五、EP_STED\45_STED技術文件
		115060806_[MASVS] Security test(00004879-24MST001-FR101V10)iOS.pdf   備註說明：06_[MASVS] Security test(00004879-24MST001-FR101V10) for iOS

	22_十五、EP_STED\45_STED技術文件
		115060861b13_LX [ISO 10993-1] Evaluation report LK_QR-EVA-LX-001_2405.pdf   備註說明：LX [ISO 10993-1] Evaluation report LK_QR-EVA-LX-001

	22_十五、EP_STED\44_「醫療器材安全性與功效性基本規範及技術文
		1150608醫療器材安全性與功效性基本規範及技術文件摘要(STED)_0608送件.pdf

	22_十五、EP_STED\45_STED技術文件
		1150608251_LK_QR-RD-LU700-117_Software Release(software level of support)_Q.xlsx.pdf   備註說明：LK_QR-RD-LU700-117_Software Release(software level of support)

	22_十五、EP_STED\45_STED技術文件
		1150608263_LK_QR-RD-LU700-107_Software Detail Design Specification(LU700_SDD)_D.pdf   備註說明：LK_QR-RD-LU700-107_Software Detail Design Specification

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QI-PD-X03-Ver_02 LX系列產線檢測規範_controlled.pdf   備註說明：LK_QI-PD-X03-Ver_02 LX系列產線檢測規範

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RMF-006Risk Management ReportE 23(LK_QR-RMF-LU700-005)_A4.pdf   備註說明：LK_QR-RMF-006Risk Management Report

	22_十五、EP_STED\45_STED技術文件
		115060811-7_LX IEC 60601-2-37 (TSSM2410000452L3)f_2503.pdf   備註說明：LX IEC 60601-2-37 (TSSM2410000452L3)

	22_十五、EP_STED\45_STED技術文件
		1150608LX IEC60529(IP68)YX10009B.pdf   備註說明：LX IEC60529 (IP68)_LX128LC, LX192LC

	22_十五、EP_STED\45_STED技術文件
		1150608LU700 [UN38.3] g02.NO.ZKS200300119-2 鋰電池 測試Summary.pdf   備註說明：[UN38.3] 鋰電池測試Summary NO.ZKS200300119-2 

	22_十五、EP_STED\45_STED技術文件
		1150608LK_QR-RD-LX-028 LX_[IEC 61390]Clinical Measurement Accuracy and System SensitivityA25.pdf   備註說明：LK_QR-RD-LX-028 LX_[IEC 61390]Clinical Measurement Accuracy and System Sensitivity

	22_十五、EP_STED\45_STED技術文件
		115060811-7_LX IEC 60601-1-12 (TSSM2410000451L2)f_2503.pdf   備註說明：LX IEC 60601-1-12 (TSSM2410000451L2)
6、臨床前測試

	25_電性安全
		115060311-2_LX IEC 60601-1(TSSM2410000449L0)f_2503.pdf   備註說明：IEC 60601-1 (Report no.: TSSM2410000449L0)

	26_電磁相容性
		115060311-3_LX IEC 60601-1-2 (EUEC249094002)2502.pdf   備註說明：IEC 60601-1-2完整報告

	26_電磁相容性
		115060311-3_LX 3235 [EN301 489-1,-17](EUEC249094001)Photos2502.pdf   備註說明：IEC 60601-1-2 完整報告之附件圖片

	27_生物相容性
		115060306.1b01_LK_QR-EVA-LX-002 _ISO10993-18 Evaluation report_Ver_01_2501.pdf   備註說明：10993-18 Evaluation Report，說明LX系列產品與LK128 系列產品適用同一份測試報告之評估

	27_生物相容性
		115060306.1b01_128 ISO 10993-5 In Vitro Cytotoxicity MTT_2023-3313-001（E）24.pdf

	27_生物相容性
		115060306.1b01_128 ISO 10993-10 Skin Sensitization 2023-3313-004 （E）24.pdf

	27_生物相容性
		115060361b13_LX [ISO 10993-1] Evaluation report LK_QR-EVA-LX-001_2405.pdf   備註說明：10993-1 Evaluation Report，說明LX系列產品與LK128 系列產品適用同一份測試報告之評估

	27_生物相容性
		115060306.1b01_128 ISO 10993-23 Vaginal Irritation 2023-3313-003(E)24.pdf   備註說明：Vaginal Irritation

	27_生物相容性
		115060306.1b01_128 ISO 10993-23 Intracutaneous Reactivity 2023-3313-002(E)24.pdf   備註說明：Intracutaneous Reactivity

	29_安定性試驗
		115060311_LK_QR-RD-LU800-025 Lifetime Evaluation Report with att._Ver_04_issued.pdf   備註說明：Lifetime Evaluation Report

	30_功能性測試
		115060311-7_LX IEC 60601-2-37 (TSSM2410000452L3)f_2503.pdf   備註說明：IEC 60601-2-37 醫用超音波診斷與監視設備的專用安全要求

	30_功能性測試
		115060311-7_LX IEC 60601-1-12 (TSSM2410000451L2)f_2503.pdf   備註說明：IEC 60601-1-12 緊急醫療服務環境報告

	30_功能性測試
		115060311-7_LX IEC 60601-1-6 (TSSM2410000450L1)f_2503.pdf   備註說明：IEC 60601-1-6 可用性報告

	32_軟體確效\63_醫療器材軟體開發環境(Software 
		1150603240_LK_QR-RD-LU700-101_Software Design and Development Plan_D 2402.docx.pdf   備註說明：LK_QR-RD-LU700-101_Software Design and Development Plan_D

	32_軟體確效\56_醫療器材軟體之風險等級(Level of
		1150603230_LK_QR-RD-LU700-100_Software Safety Classification_Ver_02.docx.pdf   備註說明：LK_QR-RD-LU700-100_Software Safety Classification_Ver_02

	32_軟體確效\60_醫療器材軟體設計架構圖(Architec
		1150603234_LK_QR-RD-LU700-103_Appendix 1 SAD Chart_D23.docx.pdf   備註說明：LK_QR-RD-LU700-103_Appendix 1 SAD Chart_D

	32_軟體確效\62_追溯性分析 (Traceability 
		1150603LK_QR-RD-LU700-138_Software Verification Validation Traceability Matrix_D_A4.pdf   備註說明：LK_QR-RD-LU700-138_Software Verification Validation Traceability Matrix_D

	32_軟體確效\64_查證與確認文件 (Verificatio
		1150603LK_QR-RD-LU700-137_User Test Report_C_A4.pdf   備註說明：LK_QR-RD-LU700-137_User Test Report_C

	32_軟體確效\64_查證與確認文件 (Verificatio
		1150603241_LK_QR-RD-LU700-105_Software Verification and Validation_D.docx.pdf   備註說明：LK_QR-RD-LU700-105_Software Verification and Validation_D

	32_軟體確效\64_查證與確認文件 (Verificatio
		1150603241_LK_QR-RD-LU700-121_Software System Test Report_Q.xlsx.pdf   備註說明：LK_QR-RD-LU700-121_Software System Test Report_Q

	32_軟體確效\64_查證與確認文件 (Verificatio
		1150603241_LK_QR-RD-LU700-112_Software System Test Plan_D.docx.pdf   備註說明：LK_QR-RD-LU700-112_Software System Test Plan_D

	32_軟體確效\64_查證與確認文件 (Verificatio
		1150603LK_QR-RD-LU700-136_User Test Plan_C_A4.pdf   備註說明：LK_QR-RD-LU700-136_User Test Plan_C

	32_軟體確效\65_醫療器材軟體修訂歷史紀錄(Revisio
		1150603242_LK_QR-RD-LU700-120_Software Configuration Status Report_Q.xls.pdf   備註說明：LK_QR-RD-LU700-120_Software Configuration Status Report_Q

	32_軟體確效\66_未解決的異常(Unresolved An
		1150603LK_QR-RD-LU700-128_Software Bug List_J_A4.pdf   備註說明：LK_QR-RD-LU700-128_Software Bug List_J

	32_軟體確效\58_醫療器材之危害分析 (Device Ha
		1150603LK_QR-RMF-004Risk assessment, risk control measuresF 24(LK_QR-RMF-LU700-004)_A4.pdf   備註說明：LK_QR-RMF-004 Risk assessment, risk control measures_F
	...
	32_軟體確效\57_醫療器材軟體之描述 (Software 
		1150603231_LK_QR-RD-LU700-103_Software General Design(7,8,LX)_D24.pdf   備註說明：LK_QR-RD-LU700-103_Software General Design(7,8,LX)_D

	32_軟體確效\61_醫療器材軟體設計規格(Software 
		1150603空白.pdf   備註說明：同Software Description &amp; Architecture Design chart檔案

	32_軟體確效\59_醫療器材軟體之要求規格(Software
		1150603233_LK_QR-RD-LU700-102_Software Requirements Specification(SRS)_D.docx.pdf   備註說明：LK_QR-RD-LU700-102_Software Requirements Specification(SRS)_D

	33_網路安全性
		1150603LK_QR-RMF-LU700-006 CBOM for OTS Software_2402[ok]_A4.pdf   備註說明：LK_QR-RMF-LU700-006 CBOM for OTS Software

	33_網路安全性
		1150603LK_QR-RD-LU700-030 Medical device Cybersecurity Management Plan and Report_A4.pdf   備註說明：LK_QR-RD-LU700-030 Medical device Cybersecurity Management Plan and Report

	34_重處理
		1150603空白.pdf   備註說明：同產品使用手冊，第26頁清潔與消毒

	36_原廠品質管制
		1150603超象-放行單+檢驗報告.pdf   備註說明：委託製造廠之品質管制檢驗報告
Sample processed doc list:廠商申請資料總表
項次	分類	目錄	檔名	備註
1	行政文件	1_送審表\1_須檢附至食藥署文件	1150514查驗登記＿第2、3等級申請醫療器材查驗登記送審表_Q10_signed.pdf	第二等級醫療器材查驗登記送審表
2	行政文件	2_二、背景說明_優先審查\4_背景說明	1150505醫療器材查驗登記申請書_v68one.pdf	V6one/8one(案號MDE11504220016)
3	行政文件	2_二、背景說明_優先審查\4_背景說明	1150505查驗登記＿第2、3等級醫療器材查驗登記申請書_v4(用印).pdf	V4(案號MDE11504270013)
4	行政文件	2_二、背景說明_優先審查\4_背景說明	1150505醫療器材查驗登記申請書_z20.pdf	Z20(案號MDE11503050025)
5	行政文件	5_二三等級查登申請書	1150514查驗登記＿第2、3等級醫療器材查驗登記申請書_Q10_signed.pdf	第二等級醫療器材查驗登記申請書
6	行政文件	8_四、醫材商許可執照\15_販賣業	1150505販賣業醫療暨財商許可執照_2026變更.pdf	醫療器材商許可執照
7	行政文件	9_六、製售證明	1150514FSC_Q10.pdf	出產國製售證明
8	行政文件	10_五、原廠授權登記書\17_授權書	115051402.Samsung US_QSD LOA - TAIJI _20260313_Final_signed.pdf	授權書
9	行政文件	13_十一、標籤說明書擬稿\23_中文標籤	1150511中文標籤_說明書或包裝擬稿_Q10.pdf	中文標籤
10	行政文件	13_十一、標籤說明書擬稿\27_中文說明書	1150514EVO Q10中文說明書.pdf	中文說明書擬稿及產品圖片
11	行政文件	13_十一、標籤說明書擬稿\24_原廠標籤	1150511原廠標籤_說明書或包裝擬稿_Q10.pdf	原廠標籤、包裝
12	行政文件	13_十一、標籤說明書擬稿\25_原廠說明書	11505116. EVO Q Series_V1.00_Service Manual.pdf	原廠型錄及使用說明書
13	技術性資料	14_十二、結構_材料_規格等\35_操作手冊	11505056. EVO Q Series_V1.00_Service Manual.pdf	原廠操作手冊
14	技術性資料	14_十二、結構_材料_規格等\34_產品性能	11505056. EVO Q Series_V1.00_產品性能.pdf	產品性能
15	技術性資料	14_十二、結構_材料_規格等\33_用途說明	11505056. EVO Q Series_V1.00_使用方法及用途說明.pdf	使用方法及用途說明
16	技術性資料	14_十二、結構_材料_規格等\32_產品規格	11505056. EVO Q Series_V1.00_Product Specifications.pdf	產品規格
17	技術性資料	14_十二、結構_材料_規格等\30_組成名稱	11505056. EVO Q Series_V1.00_產品之結構、各部分組成名稱.pdf	產品之結構、各部分組成名稱
18	技術性資料	14_十二、結構_材料_規格等\31_材料對照	11505056. EVO Q Series_V1.00_各部分組成及材料之對照表.pdf	各部分組成及材料之對照表
19	技術性資料	14_十二、結構_材料_規格等\29_圖樣	11505058. TW_EVO Q Series_V1.00_Product Photos.pdf	圖樣
20	臨床前測試	25_電性安全	1150511REP087030 CBTC IEC60601-1 Samsung Medison Q30 (Original).pdf	Original CBTC
21	臨床前測試	25_電性安全	1150511REP107347 CBTC IEC60601-1 Samsung Medison Q30 (Amd1).pdf	Amd CBTC
22	臨床前測試	25_電性安全	1150511REP107347 CBTR IEC60601-1 Samsung Medison Q30 (Amd1).pdf	Amd CBTR
23	臨床前測試	25_電性安全	1150511REP087030 CBTR IEC60601-1 Samsung Medison Q30 (Original).pdf	Original CBTR
24	臨床前測試	26_電磁相容性	1150511REP122403_삼성메디슨_Q30_CE 4.1th_compressed-已壓縮.pdf	IEC60601-1-2
25	臨床前測試	27_生物相容性	共 23 份探頭細胞毒性、刺激、致敏報告（涵蓋 EV2-10A, LA2-9S, LA3-16AD, PA2-9S, CA4-10M, PA1-5AED, MMPT3-7, L3-22, CW6.0, CV1-8A 系列, EA2-11AR 系列, LA3-22AI, DP2B, TA2-9 等）	探頭生物相容性試驗報告紀錄
26	臨床前測試	30_功能性測試	共 22 份影像效能測試報告（包含 CA2-8AD, PA1-5AED, TA2-9, EA2-11AVE, CA4-10M, LA3-16AD, LA2-9SD, L3-22, LA2-16S, EV2-10A, PA2-9S, LA3-22AI, CA1-7SD, PA3-15S, MMPT3-7, CW6.0, CV1-8AE, DP2B 等探頭）	各探頭臨床前影像功能測試（Pass）
27	臨床前測試	32_軟體確效	共 9 份軟體文件（涵蓋軟體設計規格、需求規格、風險分析、架構圖、追溯性分析、修訂紀錄與安全等級描述）	115051113_1. Software Validation_EVO Q Series_V1.00.pdf 等確效文件
28	臨床前測試	33_網路安全性	115051116. CYBERSECURITY_SELF_ASSESSMENT_REPORT_EVO2_v1.00.00.pdf	網路安全性評估自我宣告報告


default review checklist: <!DOCTYPE html>
<html lang="zh-TW">
<head>
    <meta charset="UTF-8">
